...
\begin{document}
    ...
    \framecard{\largetext{Da li je Jokić zapravo bio u kutiji?}}
    \framepic{dominoes}{
    ...
    \framecard{\hugetext{Zašto je ovo bitno?}}
    \framepic{chain}{
        \frametitle{Potpun poredak?}
    }
    \framecard{\hugetext{Hvala na pažnji!}}
\end{document}
